...
import { Menu, X, ChevronRight, Home, User, Shield, FileJson } from "lucide-react"
...
const sidebarVariants = cva(
  "fixed inset-y-0 left-0 z-50 w-64 bg-black/80 backdrop-blur-lg border-r border-white/10 transform transition-transform duration-300 ease-in-out",
  {
    variants: {
      open: {
        true: "translate-x-0",
  ...
  return (
    <div className="mb-2">
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
      >
        <motion.div animate={{ rotate: isOpen ? 90 : 0 }} transition={{ duration: 0.2 }} className="mr-1">
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Overlay */}
      <div className={overlayVariants({ open })} onClick={closeSidebar} />

      {/* Sidebar */}
      <div className={sidebarVariants({ open })}>
          ...
          <nav className="flex-1 p-4">
            ...
            >
              <Link
                ...
                className="flex items-center px-4 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white transition-all"
              >
